...
\begin{itemize}
	...
	I design pattern ci permettono appunto di risolvere alcuni problemi. Eccone alcuni di essi:
		\begin{itemize}
			...
			\item \textbf{Definire le interfacce degli oggetti}: TODO;
			\item \textbf{Definire le implementazioni degli oggetti}: TODO;
			\item \textbf{Mettere in pratica il riuso}: TODO;
			\item \textbf{Delega}: TODO;
			\item \textbf{Strutture correlate in compilazione e durante l'esecuzione}: TODO;
			\item \textbf{Progettare per il cambiamento}: TODO;
			\item \textbf{Delega}: TODO;
		\end{itemize}
